...
class _CartPageState extends State<CartPage> {
  // Set để lưu trữ các item được chọn
        ...
        body: BlocBuilder<CartBloc, CartState>(
          builder: (context, state) {
            ...
            if (state is CartLoaded) {
              // Reset selected items nếu cart thay đổi
  ...
  void _proceedToCheckout(BuildContext context) {
    ...
    if (cartState is CartLoaded) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Đang chuyển đến trang thanh toán với ${selectedCartItems.length} sản phẩm...',
      ...
      // TODO: Navigate to checkout page with selectedCartItems
      // Navigator.push(
      //   context,
      //   MaterialPageRoute(
